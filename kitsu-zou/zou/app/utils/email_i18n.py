...
EMAIL_TRANSLATIONS = {
    "en_US": {
        ...
        "comment_subject": "[画宗] %(task_status_name)s - %(author_first_name)s commented on %(task_name)s",
...
""",
        ...
        "mention_subject": "[画宗] %(author_first_name)s mentioned you on %(task_name)s",
...
""",
        ...
        "assignation_subject": "[画宗] You were assigned to %(task_name)s",
...
""",
        # Reply notification
        "reply_subject": "[画宗] %(author_first_name)s replied on %(task_name)s",
...
""",
        ...
        "playlist_subject": "[画宗] The playlist %(playlist_name)s in project %(project_name)s is ready for review",
...
""",
        ...
        # Auth: Email OTP
        "auth_otp_subject": "%(organisation_name)s - 画宗: your verification code",
...
""",
        ...
        "auth_password_changed_subject": "%(organisation_name)s - 画宗: password changed",
...
""",
        ...
        "auth_password_recovery_subject": "%(organisation_name)s - 画宗: password recovery",
...
""",
        # Auth: Invitation
        "auth_invitation_subject": "You are invited by %(organisation_name)s to 加入画宗平台",
        "auth_invitation_title": "欢迎加入画宗",
...
""",
        ...
        "auth_password_changed_by_admin_subject": "%(organisation_name)s - 画宗: password changed",
...
""",
        ...
        "auth_2fa_disabled_by_admin_subject": "%(organisation_name)s - 画宗: two factor authentication disabled",
...
""",
    ...
    "fr_FR": {
        # Comment notification
        "comment_subject": "[画宗] %(task_status_name)s - %(author_first_name)s a commenté %(task_name)s",
...
""",
        # Mention notification
        "mention_subject": "[画宗] %(author_first_name)s vous a mentionné sur %(task_name)s",
...
""",
        # Assignation notification
        "assignation_subject": "[画宗] Vous avez été assigné à %(task_name)s",
...
""",
        # Reply notification
        "reply_subject": "[画宗] %(author_first_name)s a répondu sur %(task_name)s",
...
""",
        # Playlist ready notification
        "playlist_subject": "[画宗] La playlist %(playlist_name)s du projet %(project_name)s est prête pour relecture",
...
""",
        ...
        "auth_otp_subject": "%(organisation_name)s - 画宗 : votre code de vérification",
...
""",
        "auth_password_changed_subject": "%(organisation_name)s - 画宗 : mot de passe modifié",
...
""",
        "auth_password_recovery_subject": "%(organisation_name)s - 画宗 : récupération de mot de passe",
...
""",
        # Auth: Password changed by admin
        "auth_password_changed_by_admin_subject": "%(organisation_name)s - 画宗 : mot de passe modifié par un administrateur",
...
""",
        # Auth: Two factor authentication disabled by admin
        "auth_2fa_disabled_by_admin_subject": "%(organisation_name)s - 画宗 : authentification à deux facteurs désactivée",
...
""",
    ...
    "es_ES": {
        # Comment notification
        "comment_subject": "[画宗] %(task_status_name)s - %(author_first_name)s comentó en %(task_name)s",
...
""",
        # Mention notification
        "mention_subject": "[画宗] %(author_first_name)s te mencionó en %(task_name)s",
...
""",
        # Assignation notification
        "assignation_subject": "[画宗] Has sido asignado a %(task_name)s",
...
""",
        # Reply notification
        "reply_subject": "[画宗] %(author_first_name)s respondió en %(task_name)s",
...
""",
        # Playlist ready notification
        "playlist_subject": "[画宗] La playlist %(playlist_name)s del proyecto %(project_name)s está lista para revisión",
...
""",
        ...
        "auth_otp_subject": "%(organisation_name)s - 画宗: tu código de verificación",
...
""",
        "auth_password_changed_subject": "%(organisation_name)s - 画宗: contraseña cambiada",
...
""",
        "auth_password_recovery_subject": "%(organisation_name)s - 画宗: recuperación de contraseña",
...
""",
        # Auth: Password changed by admin
        "auth_password_changed_by_admin_subject": "%(organisation_name)s - 画宗: contraseña cambiada por un administrador",
...
""",
        # Auth: Two factor authentication disabled by admin
        "auth_2fa_disabled_by_admin_subject": "%(organisation_name)s - 画宗: autenticación de dos factores desactivada",
...
""",
    ...
    "ja_JP": {
        # Comment notification
        "comment_subject": "[画宗] %(task_status_name)s - %(author_first_name)s が %(task_name)s にコメントしました",
...
""",
        # Mention notification
        "mention_subject": "[画宗] %(author_first_name)s が %(task_name)s であなたをメンションしました",
...
""",
        # Assignation notification
        "assignation_subject": "[画宗] %(task_name)s にアサインされました",
...
""",
        # Reply notification
        "reply_subject": "[画宗] %(author_first_name)s が %(task_name)s に返信しました",
        "reply_title": "新しい返信",
...
""",
        # Playlist ready notification
        "playlist_subject": "[画宗] プロジェクト %(project_name)s のプレイリスト %(playlist_name)s がレビュー可能です",
...
""",
        ...
        "auth_otp_subject": "%(organisation_name)s - 画宗: 認証コード",
...
""",
        "auth_password_changed_subject": "%(organisation_name)s - 画宗: パスワードを変更しました",
...
""",
        "auth_password_recovery_subject": "%(organisation_name)s - 画宗: パスワードのリセット",
...
""",
        # Auth: Password changed by admin
        "auth_password_changed_by_admin_subject": "%(organisation_name)s - 画宗: 管理者によりパスワードが変更されました",
...
""",
        # Auth: Two factor authentication disabled by admin
        "auth_2fa_disabled_by_admin_subject": "%(organisation_name)s - 画宗: 管理者により二要素認証が無効化されました",
...
""",
    ...
    "de_DE": {
        "comment_subject": "[画宗] %(task_status_name)s - %(author_first_name)s hat %(task_name)s kommentiert",
...
""",
        "mention_subject": "[画宗] %(author_first_name)s hat Sie in %(task_name)s erwähnt",
...
<p><em>%(comment_text)s</em></p>
""",
        "assignation_subject": "[画宗] Sie wurden %(task_name)s zugewiesen",
...
""",
        "reply_subject": "[画宗] %(author_first_name)s hat auf %(task_name)s geantwortet",
...
<p><em>%(reply_text)s</em></p>
""",
        "playlist_subject": "[画宗] Die Playlist %(playlist_name)s im Projekt %(project_name)s ist zur Überprüfung bereit",
...
""",
        ...
        "auth_otp_subject": "%(organisation_name)s - 画宗: Ihr Bestätigungscode",
...
""",
        "auth_password_changed_subject": "%(organisation_name)s - 画宗: Passwort geändert",
...
""",
        "auth_password_recovery_subject": "%(organisation_name)s - 画宗: Passwort-Wiederherstellung",
...
""",
        # Auth: Password changed by admin
        "auth_password_changed_by_admin_subject": "%(organisation_name)s - 画宗: Passwort von einem Administrator geändert",
...
""",
        # Auth: Two factor authentication disabled by admin
        "auth_2fa_disabled_by_admin_subject": "%(organisation_name)s - 画宗: Zwei-Faktor-Authentifizierung deaktiviert",
...
""",
    ...
    "nl_NL": {
        "comment_subject": "[画宗] %(task_status_name)s - %(author_first_name)s heeft gereageerd op %(task_name)s",
...
""",
        "mention_subject": "[画宗] %(author_first_name)s heeft je vermeld in %(task_name)s",
...
<p><em>%(comment_text)s</em></p>
""",
        "assignation_subject": "[画宗] Je bent toegewezen aan %(task_name)s",
...
""",
        "reply_subject": "[画宗] %(author_first_name)s heeft geantwoord op %(task_name)s",
...
<p><em>%(reply_text)s</em></p>
""",
        "playlist_subject": "[画宗] De playlist %(playlist_name)s in project %(project_name)s is klaar voor beoordeling",
...
""",
        ...
        "auth_otp_subject": "%(organisation_name)s - 画宗: uw verificatiecode",
...
""",
        "auth_password_changed_subject": "%(organisation_name)s - 画宗: wachtwoord gewijzigd",
...
""",
        "auth_password_recovery_subject": "%(organisation_name)s - 画宗: wachtwoordherstel",
...
""",
        # Auth: Password changed by admin
        "auth_password_changed_by_admin_subject": "%(organisation_name)s - 画宗: wachtwoord gewijzigd door een beheerder",
...
""",
        # Auth: Two factor authentication disabled by admin
        "auth_2fa_disabled_by_admin_subject": "%(organisation_name)s - 画宗: tweefactorauthenticatie uitgeschakeld",
...
""",
    ...
    "zh_CN": {
        "comment_subject": "[画宗] %(task_status_name)s - %(author_first_name)s 在 %(task_name)s 上发表了评论",
        "comment_title": "新评论",
...
""",
        ...
        "auth_otp_subject": "%(organisation_name)s - 画宗：您的验证码",
...
""",
        "auth_password_changed_subject": "%(organisation_name)s - 画宗：密码已修改",
...
""",
        "auth_password_recovery_subject": "%(organisation_name)s - 画宗：找回密码",
...
""",
        # Auth: Password changed by admin
        "auth_password_changed_by_admin_subject": "%(organisation_name)s - 画宗：管理员已更改密码",
...
""",
        # Auth: Two factor authentication disabled by admin
        "auth_2fa_disabled_by_admin_subject": "%(organisation_name)s - 画宗：双因素认证已被管理员禁用",
...
""",
    ...
    "pt_BR": {
        "comment_subject": "[画宗] %(task_status_name)s - %(author_first_name)s comentou em %(task_name)s",
...
""",
        "mention_subject": "[画宗] %(author_first_name)s mencionou você em %(task_name)s",
...
<p><em>%(comment_text)s</em></p>
""",
        "assignation_subject": "[画宗] Você foi atribuído a %(task_name)s",
...
""",
        "reply_subject": "[画宗] %(author_first_name)s respondeu em %(task_name)s",
        "reply_title": "Nova resposta",
        "reply_body": """<p><strong>%(author_full_name)s</strong> respondeu em <a href="%(task_url)s">%(task_name)s</a>.</p>

<p><em>%(reply_text)s</em></p>
""",
        "playlist_subject": "[画宗] A playlist %(playlist_name)s no projeto %(project_name)s está pronta para revisão",
...
""",
        ...
        "auth_otp_subject": "%(organisation_name)s - 画宗: seu código de verificação",
...
""",
        "auth_password_changed_subject": "%(organisation_name)s - 画宗: senha alterada",
...
""",
        "auth_password_recovery_subject": "%(organisation_name)s - 画宗: recuperação de senha",
...
""",
        # Auth: Password changed by admin
        "auth_password_changed_by_admin_subject": "%(organisation_name)s - 画宗: senha alterada por um administrador",
...
""",
        # Auth: Two factor authentication disabled by admin
        "auth_2fa_disabled_by_admin_subject": "%(organisation_name)s - 画宗: autenticação de dois fatores desativada",
