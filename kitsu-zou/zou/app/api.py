...
from zou.app.blueprints.global_assets import blueprint as global_assets_blueprint
from zou.app.blueprints.open_api import blueprint as open_api_blueprint
...
def configure_api_routes(app):
    ...
    app.register_blueprint(global_assets_blueprint)
    app.register_blueprint(open_api_blueprint)
    return app
