...
from zou.app.blueprints.projects.dashboard_resources import (
    ProductionDashboardResource,
)
from zou.app.blueprints.projects.permission_resources import (
    ProjectTeamRolesResource,
    ProjectMemberRoleResource,
    EntityAccessControlListResource,
    EntityAccessControlResource,
    ProjectRoleTypesResource,
)
from zou.app.blueprints.projects.template_resources import (
    ProjectTemplatesResource,
    ProjectTemplateResource,
    ProjectFromTemplateResource,
)
...
routes = [
    ...
    ("/data/project-templates/<template_id>", ProjectTemplateResource),
    ("/data/project-templates/<template_id>/create-project", ProjectFromTemplateResource),
    ("/data/projects/<project_id>/dashboard", ProductionDashboardResource),
    ("/data/projects/<project_id>/team-roles", ProjectTeamRolesResource),
    ("/data/projects/<project_id>/team/<person_id>/role", ProjectMemberRoleResource),
    ("/data/projects/<project_id>/access-controls", EntityAccessControlListResource),
    ("/data/projects/<project_id>/access-controls/<acl_id>", EntityAccessControlResource),
    ("/data/project-role-types", ProjectRoleTypesResource),
