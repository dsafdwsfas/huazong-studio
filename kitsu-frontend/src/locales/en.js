export default {
  ...
  status_automations: {
    ...
    title: 'Automations',
    wrong_automation: 'This automation applies to a upstream task type. It is not permitted by HuaZong (to avoid infinite cycles). It will have no effect.',
    fields: {
      entity_type: 'Entity Type',
  ...
  intro: {
    ...
    seven: 'Share HuaZong with your friends and colleagues',
    eight: 'Thank you for your help!',
    title: 'How to support HuaZong'
  },
  ...
  login: {
    ...
    first_connection_2: 'Please provide the email used for your HuaZong account and we will send you the reset password link.',
    first_connection_title: 'Welcome to HuaZong!',
    ...
    set_password_title: 'Welcome to HuaZong!',
    set_password: 'Set your password',
    title: 'Log in to HuaZong',
  ...
  notifications: {
    ...
    playlist_is_ready: 'Playlist is ready',
    playlist_ready_text: 'A new playlist is ready for review:',
    publish: 'Publish',
  ...
  playlists: {
    ...
    clients_to_notify: 'Clients to notify',
    ...
    no_build: 'No build',
    no_clients_to_notify: 'There are no clients to notify.',
    ...
    notify_clients_success: 'The notification has been sent successfully.',
  ...
  productions: {
    ...
    delete_error: 'An error occurred while deleting this production. There may be existing data currently linked to it. Are you sure this production has no task, shot, or asset linked to it? HuaZong doesn\'t allow production deletion. If you don\'t want to see the production anymore, you can close it instead.',
  ...
  server_down: {
    ...
    title: 'HuaZong encountered an error while reaching its data API'
  },
  ...
  wrong_browser: {
    title: 'Your Browser is Not Supported by HuaZong',
    text: 'HuaZong can only be used with Firefox and Chrome browsers.'
  },
